...
const std::vector<FactoryPreset>& getFactoryPresets()
{
    static const std::vector<FactoryPreset> presets = {
        ...
        {"Modern Rhythm", {
            {param::gain, 0.75f}, {param::boost, 1.0f}, {param::tight, 130.0f},
        ...
        {"Djent", {
            {param::gain, 0.8f}, {param::boost, 1.0f}, {param::tight, 190.0f},
        ...
        {"Doom", {
            {param::gain, 0.9f}, {param::tight, 55.0f}, {param::tone, 0.35f},
        ...
        {"Ambient Swells", {
            {param::gain, 0.4f}, {param::octaveLevel, 0.5f}, {param::gateOn, 0.0f},
